            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" placeholder="Your name"
                           class="bg-gray-800 border-2 border-gray-700 text-white w-full p-4 rounded-lg
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="username" id="username" placeholder="Username"
                           class="bg-gray-800 border-2 border-gray-700 w-full p-4 rounded-lg
                ...
                <div>
                    <button type="submit"
                            class="bg-gray-900 border-2 border-gray-700 text-white px-4 py-3 rounded font-medium w-full"
                    >
                        Register
                    </button>
                </div>
